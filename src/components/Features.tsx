...
const Features = () => {
  const features = [
    ...
    },
    {
      icon: Users,
      title: 'دروس فردية',
      description: 'دروس خاصة مع المعلم لتعليم مخصص وتركيز كامل على احتياجاتك الشخصية',
    ...
    },
    {
      icon: Users,
      title: 'دروس جماعية',
      description: 'انضم لمجموعات تعليمية تفاعلية مع طلاب آخرين لتجربة تعلم ممتعة ومشتركة',
